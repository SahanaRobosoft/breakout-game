...
var render = function render(_a) {
  ...
  document.body.innerHTML = "Score: ".concat(player.score, " Lives: ").concat(player.lives, " <br/>");
...
var player$ = (0, rxjs_1.combineLatest)((0, rxjs_1.of)(__assign(__assign({}, createGameObject(constants_1.gameSize - 2, constants_1.gameSize / 2 - 1)), {
  score: 0,
  lives: 3
})), (0, rxjs_1.fromEvent)(document, "keyup").pipe((0, operators_1.startWith)({
  code: ""
}), (0, operators_1.pluck)("code"))).pipe((0, operators_1.map)(function (_a) {
  var player = _a[0],
    key = _a[1];
...
var ball$ = (0, rxjs_1.combineLatest)((0, rxjs_1.of)(__assign(__assign({}, createGameObject(constants_1.gameSize / 2, constants_1.gameSize - 3)), {
  dirX: 1,
  dirY: 1
})), (0, rxjs_1.interval)(150)).pipe((0, operators_1.map)(function (_a) {
  var ball = _a[0],
    _ = _a[1];
...
var bricks$ = (0, rxjs_1.generate)(1, function (x) {
  ...
  return x + 1;
}).pipe((0, operators_1.mergeMap)(function (r) {
...
(0, rxjs_1.combineLatest)(player$, ball$, bricks$).pipe((0, operators_1.scan)(processGameCollisions), (0, operators_1.tap)(html_renderer_1.render), (0, operators_1.takeWhile)(function (_a) {
  var player = _a[0];
  return player.lives > 0;
})).subscribe();
},{"rxjs":"../node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"../node_modules/rxjs/dist/esm5/operators/index.js","./constants":"constants.ts","./html-renderer":"html-renderer.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
